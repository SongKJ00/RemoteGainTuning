...
class Window(QtGui.QMainWindow):
    ...
    txtAltGain = []     # TextBox for Altitude PID Controller Gain P, I, D
    ...
    def __init__(self):
        ...
        self.setGeometry(1100, 150, 650, 800)
    ...
    def createInstance(self):
        ...
        for i in range(0, 3):
            txtAltGainObj = QtGui.QLineEdit(self)
            txtAltGainObj.setFont(QtGui.QFont('Times', 14))
            txtAltGainObj.resize(100, 40)
            txtAltGainObj.move(200 + 150 * i, 560)
            self.txtAltGain.append(txtAltGainObj)
    ...
    def transmitGainValue(self):
        txtGain = [self.txtRollGain, self.txtPitchGain, self.txtYawGain, self.txtAltGain]
        gainType = [0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x77, 0x78, 0x79]
        gainTypeIndex = 0
        baudRate = None
        ...
        selectedSerial = self.cmbPort.currentText()
